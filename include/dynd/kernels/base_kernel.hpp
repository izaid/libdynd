  ...
  struct base_kernel<SelfType> : kernel_prefix_wrapper<ckernel_prefix, SelfType> {                                     \
    ...
    {                                                                                                                  \
      ...
      return self;                                                                                                     \
                                                                                                                       ...
                                                                                                                       \
    __VA_ARGS__ static void single_wrapper(ckernel_prefix *rawself, char *dst, char *const *src)                       \
    {                                                                                                                  \
 ...
 * kernel.
 */
size_t make_expression_type_expr_kernel(void *ckb, intptr_t ckb_offset, const ndt::type &dst_tp,
