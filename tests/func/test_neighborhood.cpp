...
*/
  ...
  /*
      ...
      EXPECT_JSON_EQ_ARR("[2, 3, 1, 2]",
          af(a, kwds("mask", parse_json("4 * bool", "[true, false, false, true]"), "offset", parse_json("1 * int",
     "[-1]"))));

      EXPECT_JSON_EQ_ARR("[1, 3, 5, 3]",
          af(a, kwds("mask", parse_json("4 * bool", "[false, true, true, false]"), "offset", parse_json("1 * int",
     "[-1]"))));
